...
const Reviews = () => {
  ...
  return (
    <div
      id="testimonials"
      class="w-full lg:px-20 px-5 py-[80px] bg-gray-100 flex flex-col justify-center items-center gap-4"
    >
      <h1
        data-aos="zoom-in"
        data-aos-delay="100"
        class="text-themepurple text-xl font-semibold capitalize "
      >
      ...
      <h1
        data-aos="zoom-in"
        data-aos-delay="200"
        class="text-black font-semibold text-[42px] leading-[50px] text-center capitalize "
      >
        Our customer love
      </h1>
