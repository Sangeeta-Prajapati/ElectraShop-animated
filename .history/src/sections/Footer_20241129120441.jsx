          ...
          <div className="w-full lg:px-20 px-5 py-[60px] bg-gray-100 grid lg:grid-cols-[auto, auto, auto, auto, auto] grid-cols-1 justify-between items-start lg:gap-3 gap-10">
                ...
                >
                  <div className="flex flex-col justify-center items-start gap-y">
                    ...
                    <p className="text-gray-500 text-justify">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Non quam eveniet sunt dicta quisquam, animi voluptates tenetur nemo debitis dolorem repudiandae. Sed amet iste impedit deleniti sunt odit tenetur accusantium!</p>
                  </div>
