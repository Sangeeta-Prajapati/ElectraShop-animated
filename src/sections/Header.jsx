      ...
      <nav className="w-full bg-gray-100 flex justify-between items-center gap0-1 lg:px-16 px-6 py-5 sticky top-0 z-50">
        ...
        <ul className="lg:flex justify-center items-center gap-10 hidden">
          {navItems.map(({ link, path }) => (
            <Link
              key={path}
              className="text-black text-sm font-semibold uppercase hover:bg-themepurple rounded-lg cursor-pointer px-4 py-2 hover:text-white"
              to={path}
              spy={true}
              offset={-100}
              smooth={true}
        ...
        >
          <FaSearch className="w-[20px] h-[20px] transform hover:scale-125 transition-tranform duration-300 cursor-pointer hover:text-themepurple" />
          <IoPerson className="w-[20px] h-[20px] transform hover:scale-125 transition-tranform duration-300 cursor-pointer hover:text-themepurple" />
          <FaHeart className="w-[20px] h-[20px] transform hover:scale-125 transition-tranform duration-300 cursor-pointer hover:text-themepurple" />
          <div className="relative">
            <FaShoppingCart className="w-[20px] h-[20px] transform hover:scale-125 transition-tranform duration-300 cursor-pointer hover:text-themepurple" />
        ...
        <div
          className={`${isMenuOpen ? "flex" : "hidden"} w-full h-fit 
        bg-themepurple p-4 absolute top-[80px] left-0`}
          onClick={closeMenu}
        >
            ...
            {navItems.map(({ link, path }) => (
              <Link
                ...
                className="text-white font-semibold uppercase
                     hover:bg-themeyellow rounded-lg 
                     cursor-pointer p-3 hover:text-black w-full text-center"
                to={path}
                spy={true}
                offset={-100}
                smooth={true}
