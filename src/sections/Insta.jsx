...
const Insta = () => {
  ...
  return (
    <div className='w-full lg:px-20 px-5 py-[80px] bg-white flex flex-col justify-center items-center gap-4'>
      ...
      >Follow on Instagram</h1>
      
      <div data-aos="zoom-in" data-aos-delay="300"
      className='w-full grid lg:grid-cols-6 grid-cols-1 justify-center items-center gap-6 mt-8'>
        <img src={insta1} alt='instas' className='rounded-lg'/>
        <img src={insta2} alt='instas' className='rounded-lg'/>
        <img src={insta3} alt='instas' className='rounded-lg'/>
        <img src={insta4} alt='instas' className='rounded-lg'/>
        <img src={insta5} alt='instas' className='rounded-lg'/>
        <img src={insta6} alt='instas' className='rounded-lg'/>
      </div>

      
      <button data-aos="zoom-in" data-aos-delay="400" 
      className='bg-themepurple hover:bg-themeyellow text-white hover:text-black font-semibold
      px-8 py-3 rounded-lg mt-12 uppercase'>#ElectraShop</button>
